...
> ฉบับไทย/อังกฤษเล่าด้วยของที่มีแค่ในร้านอาหาร: เงื่อนไขหน้างานเป็นตั๋วครัวเสียบราวสแตนเลสที่เวลาเรียงเป็นหนึ่งกะ
> ราคาเป็นใบเสร็จกระดาษความร้อน (ทุกบรรทัด ฿0.00) และความปลอดภัยเป็นเช็กลิสต์แยกจากกล่องเตือน "ต้องทำก่อนใช้งานจริง" — ดู `docs/DECISIONS.md` #44
