...
- **สามภาษาทั้งระบบ: ไทย / English / 한국어** — สลับได้ที่หน้า **บัญชี** หรือหน้า **ตั้งค่า**
  ...
  ค่าที่ประทับไว้ตอนสั่ง คำแปลครบ 1,061 คีย์เท่ากันทุกภาษา ฟอนต์เกาหลีฝังมาในแอปแบบ subset เฉพาะ
...
- [x] **รองรับภาษาเกาหลี** — ทำแล้ว: คำแปล 1,061 คีย์ครบทุกฟีเจอร์ (ตรวจแล้วว่าชุดคีย์ตรงกับ
