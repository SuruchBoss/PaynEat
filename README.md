...
- **ทดสอบอัตโนมัติ 655 เคส** ก่อนปล่อยทุกครั้ง — ตั้งแต่กฎคิดเงินไปจนถึง flow เต็มร้าน 17 ขั้น
...
cd app && flutter test      # 362 เคส — domain / controller / widget
```
...
**Flutter (362 เคส)** — แบ่งเป็น 3 ระดับ:
