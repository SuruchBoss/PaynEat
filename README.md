...
- **ทดสอบอัตโนมัติ 844 เคส** ก่อนปล่อยทุกครั้ง — ตั้งแต่กฎคิดเงินไปจนถึง flow เต็มร้าน 17 ขั้น
...
cd app && flutter test      # 452 เคส — domain / controller / widget
...
**Flutter (452 เคส)** — แบ่งเป็น 3 ระดับ:
...
- [ ] **ตัดสินว่าบิลขายเชื่อควรได้แต้มสะสมตอนไหน** — ตอนนี้ได้ทันทีตอนลงบัญชีทั้งที่ยังไม่ได้รับเงิน เป็นกฎธุรกิจที่
  เจ้าของร้านต้องเลือก (ตอนลงบัญชี / ตอนรับชำระครบ / ไม่ได้เลย) จึงยังไม่เปลี่ยนเอง (ดู `docs/DECISIONS.md` #58)
