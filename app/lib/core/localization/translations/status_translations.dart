...
const Map<String, String> statusTranslationsKo = {
  ...
  'role_cashier': '캐셔',
  'role_kitchen': '주방',
  'table_status_available': '빈 테이블',
  'table_status_occupied': '사용 중',
  'table_status_reserved': '예약',
  'table_status_billing': '결제 중',
  'order_status_open': '진행 중',
  'order_status_in_kitchen': '주방 전달',
  'order_status_served': '서빙 완료',
  'order_status_paid': '결제 완료',
  'order_status_cancelled': '취소됨',
  'order_item_status_pending': '대기',
  'order_item_status_cooking': '조리 중',
  'order_item_status_ready': '조리 완료',
  'order_item_status_served': '서빙 완료',
  'order_item_status_cancelled': '취소됨',
  'order_item_next_action_pending': '조리 시작',
  'order_item_next_action_cooking': '조리 완료',
  'order_item_next_action_ready': '서빙 완료',
  'order_type_dine_in': '매장 식사',
  'order_type_takeaway': '포장',
  'order_type_delivery': '배달',
  'payment_method_cash': '현금',
  'payment_method_qr': '프롬프트페이 / QR',
