...
const Map<String, String> menuTranslationsTh = {
  ...
  'menu_form_photo_hint': 'ไฟล์ไม่เกิน 1.6MB — ไม่มีรูปก็ใช้งานได้ตามปกติ',
  'menu_form_photo_web_only': 'อัปโหลดรูปเมนูได้จากหน้าเว็บแอดมินเท่านั้น',
  'menu_form_photo_too_large': 'ไฟล์รูปใหญ่เกินไป กรุณาเลือกไฟล์ไม่เกิน 1.6MB',
...
const Map<String, String> menuTranslationsEn = {
  ...
  'menu_form_photo_hint': 'Up to 1.6MB — works fine without a photo too',
  'menu_form_photo_web_only': 'Photo upload is only available on the admin web app',
  'menu_form_photo_too_large': 'That image is too large — please pick a file under 1.6MB',
