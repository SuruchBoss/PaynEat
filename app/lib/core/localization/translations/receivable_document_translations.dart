...
const Map<String, String> receivableDocumentTranslationsTh = {
  ...
  'receivable_credit_note_invoice_owes': 'ค้าง @amount',
...
const Map<String, String> receivableDocumentTranslationsEn = {
  ...
  'receivable_credit_note_invoice_owes': 'Owes @amount',
  ...
  'receivable_credit_note_reason_label': 'Reason (printed on the note)',
  ...
  'receivable_email_message_label': 'Message (optional)',
...
const Map<String, String> receivableDocumentTranslationsKo = {
  ...
  'receivable_credit_note_reason_label': '사유 (감액 전표에 인쇄)',
  'receivable_credit_note_reason_hint': '예: 2kg 불량, 고객 반품',
  'receivable_credit_note_issue': '감액 전표 발행',
  'receivable_credit_note_success': '감액 전표 @no 발행됨',
  'receivable_credit_note_title': '감액 전표',
  ...
  'receivable_credit_notes_title': '감액 전표',
  ...
  'receivable_error_credit_note_not_credit':
      '감액 전표는 외상 청구서에만 발행할 수 있습니다 — 결제된 청구서는 일반 환불을 사용하세요',
  'receivable_error_credit_note_not_found': '감액 전표를 찾을 수 없습니다',
