...
> ภาษาไทยตามธรรมเนียมโปรเจกต์) แทนการ publish เข้า issue tracker ภายนอก เพราะโปรเจกต์นี้ยังไม่ได้
> ตั้งค่า issue tracker/triage label vocabulary ของสกิล (`/setup-matt-pocock-skills`) — ธรรมเนียม
> ที่ใช้จริงในโปรเจกต์นี้ตลอดมาคือไฟล์ ticket ใน `docs/tickets/` + index ที่ `docs/tickets/README.md`
> ซึ่งทำหน้าที่เดียวกันคือส่งงานที่พร้อมทำให้ dev/agent session ถัดไปอ่านแล้วเริ่มได้เลย
