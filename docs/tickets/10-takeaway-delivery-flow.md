...
## Acceptance Criteria
- [x] สร้างออเดอร์ takeaway ได้โดยไม่ต้องผูกกับโต๊ะ พร้อมเลขคิว/เลขรับอาหาร — ปุ่ม "สั่งกลับบ้าน/
  เดลิเวอรี่" บนหน้าผังโต๊ะ, เลขคิวรันต่อวันเฉพาะ type=takeaway
- [x] ครัว (KDS) เห็นความแตกต่างระหว่างออเดอร์ dine-in กับ takeaway/delivery ชัดเจน — ไอคอน/ป้าย
  แยกกัน 3 แบบ (โต๊ะ/ถุงกลับบ้าน/มอเตอร์ไซค์เดลิเวอรี) บนตั๋วครัวแต่ละใบ
- [x] Cashier เช็คบิล/ชำระเงินสำหรับ takeaway ได้โดยไม่ติด flow ที่บังคับเลือกโต๊ะ — หน้าเก็บเงิน/
  ใบเสร็จไม่มีจุดใดอ้างอิงโต๊ะเลยอยู่แล้วตั้งแต่ก่อนทิกเก็ตนี้ ตรวจสอบซ้ำแล้วว่าไม่มี regression
- [ ] (ถ้าทำ) เชื่อมต่อรับออเดอร์จากแพลตฟอร์มเดลิเวอรีอย่างน้อย 1 เจ้าได้ — **ตั้งใจไม่ทำ** ตามที่
  ทิกเก็ตแนะนำเอง (ขอบเขตใหญ่และขึ้นกับ external API ของแต่ละแพลตฟอร์ม ควรแยกเป็นทิกเก็ตย่อย
  ต่างหากเมื่อรู้ว่าจะเชื่อมกับเจ้าไหนจริง — ดู `docs/DECISIONS.md` #23)
