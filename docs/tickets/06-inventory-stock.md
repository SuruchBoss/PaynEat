...
## Acceptance Criteria
- [ ] Admin ผูกเมนูกับวัตถุดิบและจำนวนที่ใช้ต่อ 1 ออเดอร์ได้
- [ ] สต๊อกถูกตัดอัตโนมัติเมื่อขายเมนูที่ผูกวัตถุดิบไว้
- [ ] เมนูที่วัตถุดิบหมด (ตามที่ผูกไว้) ถูก mark unavailable อัตโนมัติ
- [ ] มีแจ้งเตือน/หน้าจอแสดงวัตถุดิบที่ใกล้หมด (ต่ำกว่า threshold)
