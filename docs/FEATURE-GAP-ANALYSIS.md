...
2. ✅ **เฟส 2 (เสร็จแล้วทั้ง 4 รายการ)**: โปรโมชัน + สต๊อก + ใบกำกับภาษี + audit log — เพื่อแข่งขันกับ POS เจ้าอื่นได้
3. **เฟส ขยายธุรกิจ**: 🟡 ลูกค้า/loyalty ✅ และ takeaway/delivery ✅ เสร็จแล้วทั้งคู่ — เหลือ
