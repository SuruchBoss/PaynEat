...
## หมายเหตุการอัปเดต — `docs/DECISIONS.md` #16 / #17 / #20

สามข้อนี้เป็นการแก้ความถูกต้อง/เครื่องมือ/ความปลอดภัย ไม่ใช่ฟีเจอร์ใหม่ จึง **ไม่ได้ปิด gap ข้อใดใน
ตารางด้านบนและไม่ได้เปิด gap ใหม่** — บันทึกไว้เพื่อให้เอกสารตรงกันตามกฎใน `CLAUDE.md`
...
- **#20 Security hardening batch (OWASP Top 10)** — แก้ช่องโหว่ 7 จุดที่พบจาก security review
  ...
  แต่เกี่ยวเนื่องกัน — ข้อ 8 ยังเป็น gap ที่เปิดอยู่เหมือนเดิม ยังไม่มี audit log ว่าใครลบ/ยกเลิก
  ออเดอร์หรือให้ส่วนลดพิเศษ
