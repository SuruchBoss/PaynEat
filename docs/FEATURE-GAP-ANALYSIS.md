...
## หมายเหตุการอัปเดต — `docs/DECISIONS.md` #16 / #17 / #20 / #21

สี่ข้อนี้ #16/#17/#20 เป็นการแก้ความถูกต้อง/เครื่องมือ/ความปลอดภัย ไม่ใช่ฟีเจอร์ใหม่ จึง **ไม่ได้ปิด
gap ข้อใดในตารางด้านบนและไม่ได้เปิด gap ใหม่** ส่วน #21 (audit log) **ปิด gap ข้อ 8** โดยตรง —
