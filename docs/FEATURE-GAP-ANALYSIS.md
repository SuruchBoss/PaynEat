...
| 7 | ใบกำกับภาษี (Tax Invoice / e-Tax) | ยังไม่รองรับข้อกำหนดใบกำกับภาษีของไทย จำเป็นถ้าจะขายให้ร้านที่จด VAT จริง | ✅ เสร็จแล้ว (เฉพาะเอกสารอย่างย่อ/เต็มรูป ยังไม่ทำ e-Tax ยื่นอิเล็กทรอนิกส์ — ดู `docs/tickets/07-tax-invoice.md`, `docs/DECISIONS.md` #16) |
...
2. **เฟส 2** (โปรโมชัน + สต๊อก + ใบกำกับภาษี ✅ เสร็จแล้ว, เหลือ 1 รายการ 🟠: audit log) — เพื่อแข่งขันกับ POS เจ้าอื่นได้
