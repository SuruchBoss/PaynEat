...
3. **เฟส ขยายธุรกิจ**: 🟡 ลูกค้า/loyalty ✅ เสร็จแล้ว — เหลือ takeaway/delivery, multi-branch,
   export รายงาน
4. **Backlog**: 🟢 nice-to-have ตามความเหมาะสม

---

## หมายเหตุการอัปเดต — `docs/DECISIONS.md` #16 / #17 / #20 / #21 / #22

ห้าข้อนี้ #16/#17/#20 เป็นการแก้ความถูกต้อง/เครื่องมือ/ความปลอดภัย ไม่ใช่ฟีเจอร์ใหม่ จึง **ไม่ได้ปิด
gap ข้อใดในตารางด้านบนและไม่ได้เปิด gap ใหม่** ส่วน #21 (audit log) **ปิด gap ข้อ 8** และ #22
(ลูกค้า/แต้มสะสม) **ปิด gap ข้อ 9** โดยตรง — บันทึกไว้เพื่อให้เอกสารตรงกันตามกฎใน `CLAUDE.md`
