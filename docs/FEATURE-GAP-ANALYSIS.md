...
### ข้อเล็กที่พบระหว่างตรวจ UI/UX แต่ยังไม่ได้แก้

| # | สิ่งที่พบ | ทำไมยังไม่แก้ |
|---|---|---|
| 13 | ชิป "ทั้งหมด" หน้าพนักงานใช้สีเทาเกือบดำตอนถูกเลือก ต่างจากหน้าอื่นที่ใช้สีส้มแบรนด์ | เป็นของเดิมตั้งแต่คอมมิตแรกของหน้านั้น ไม่ได้เกิดจากงานรอบนี้ จึงอยู่นอกขอบเขตที่ได้รับมอบหมาย |
| 14 | ปุ่มลัดเงินสดขึ้นเลข 500 ซ้ำสองปุ่มเมื่อยอดบิลทำให้ "ปัดขึ้นหลักร้อย" ได้ 500 พอดี | เป็นข้อเล็กเชิงการตัดสินใจว่าจะกรองค่าซ้ำหรือคงปุ่มไว้ตามตำแหน่งเดิม ควรให้ผู้ดูแลโปรเจกต์ตัดสิน |
| 15 | ยังไม่มีโหมดคอนทราสต์สูง/โหมดกลางคืน | ควรเป็นงานที่ตัดสินใจ palette ของโหมดที่สองโดยเฉพาะ (token สีถูกแยกไว้รองรับแล้ว) |
