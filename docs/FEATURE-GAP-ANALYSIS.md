...
## หมายเหตุการอัปเดต — `docs/DECISIONS.md` #16 / #17

สองข้อนี้เป็นการแก้ความถูกต้องและเครื่องมือ ไม่ใช่ฟีเจอร์ใหม่ จึง **ไม่ได้ปิด gap ข้อใดในตารางด้านบน
และไม่ได้เปิด gap ใหม่** — บันทึกไว้เพื่อให้เอกสารตรงกันตามกฎใน `CLAUDE.md`
