...
> The Thai/English editions tell it with objects only a restaurant has: the shift conditions are kitchen tickets on a
> steel rail, timestamped across one shift; pricing is a thermal receipt (every line ฿0.00); and security is a checklist
> kept apart from a "what to do before going live" warning box — see `docs/DECISIONS.md` #44
