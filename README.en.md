...
control and 655 automated tests.
...
- **655 automated tests** run before every release, from bill-calculation rules to a full 17-step
...
cd app && flutter test      # 362 cases — domain / controller / widget
```
...
**Flutter (362 cases)** — split into 3 levels:
